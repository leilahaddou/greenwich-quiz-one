...
$(".quiz .btn").on("click", function (event) {
    ...
    if (!$(question).hasClass("answered")) {
        ...
        if (answered == 17) {
            ...
            link.setAttribute("data-text", "I just got " + correctAnswers + "/" + answered + " on this quiz about Greenwich. Give it a go here:");
            link.setAttribute("data-url", "http://wp.me/p60KF6-78");
            ...
            else if (correctAnswers >= 9 && correctAnswers <= 15) {
